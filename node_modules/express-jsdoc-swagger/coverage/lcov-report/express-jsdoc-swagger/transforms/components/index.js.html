...
<head>
    <title>Code coverage report for express-jsdoc-swagger/transforms/components/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">express-jsdoc-swagger/transforms/components</a> index.js</h1>
        <div class='clearfix'>
...
<a name='L97'></a><a href='#L97'>97</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">7x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { getTagInfo, getTagsInfo } = require('../utils/tags');
...
const formatProperties = properties =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!properties || !Array.isArray(properties)) <span class="cstat-no" title="statement not covered" >return {};</span>
...
&nbsp;
const parseComponents = (swaggerObject = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> components = []) =&gt; {
