...
<head>
    <title>Code coverage report for express-jsdoc-swagger/transforms/paths/parameters.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">express-jsdoc-swagger/transforms/paths</a> parameters.js</h1>
        <div class='clearfix'>
...
<a name='L72'></a><a href='#L72'>72</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">13x</span>
...
&nbsp;
const parametersGenerator = (paramValues = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!paramValues || !Array.isArray(paramValues)) <span class="cstat-no" title="statement not covered" >return [];</span>
