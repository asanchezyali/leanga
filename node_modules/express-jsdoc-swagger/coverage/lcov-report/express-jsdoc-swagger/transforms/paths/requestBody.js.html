...
<head>
    <title>Code coverage report for express-jsdoc-swagger/transforms/paths/requestBody.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">express-jsdoc-swagger/transforms/paths</a> requestBody.js</h1>
        <div class='clearfix'>
...
<a name='L65'></a><a href='#L65'>65</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">13x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const setProperty = require('../utils/setProperty')('parameter');
...
&nbsp;
const requestBodyGenerator = (params = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> examples) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!params || !Array.isArray(params)) <span class="cstat-no" title="statement not covered" >return {};</span>
