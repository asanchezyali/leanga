...
<head>
    <title>Code coverage report for express-jsdoc-swagger/transforms/paths/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">express-jsdoc-swagger/transforms/paths</a> index.js</h1>
        <div class='clearfix'>
...
<a name='L104'></a><a href='#L104'>104</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">13x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const examplesGenerator = require('./examples');
...
&nbsp;
const formatTags = (tags = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> =&gt; tags.map(({ description }) =&gt; {
  const { name } = formatDescriptionTag(description);
  return name;
});
&nbsp;
const formatSecurity = (securityValues = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> =&gt; securityValues.map(({ description }) =&gt; ({
  [description]: [],
}));
&nbsp;
...
const parsePath = (path, state) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!path.description || !path.tags) <span class="cstat-no" title="statement not covered" >return {};</span>
...
&nbsp;
const parsePaths = (swaggerObject = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> paths = []) =&gt; {
