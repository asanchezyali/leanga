...
<head>
    <title>Code coverage report for express-jsdoc-swagger/transforms/paths/examples.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">express-jsdoc-swagger/transforms/paths</a> examples.js</h1>
        <div class='clearfix'>
...
<a name='L97'></a><a href='#L97'>97</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">13x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const STATUS_CODES = require('./validStatusCodes');
&nbsp;
...
const parseResponsePayloadExample = (description, content) =&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!STATUS_CODES[status]) {
<span class="cstat-no" title="statement not covered" >    errorMessage(`${status} is not a valid status for a response`);</span>
...
<span class="cstat-no" title="statement not covered" >      errorMessage(`Cannot determine where to use example of type ${type}`);</span>
<span class="cstat-no" title="statement not covered" >      return {};</span>
  }
};
&nbsp;
 ...
 */
const examplesGenerator = (exampleTags = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!exampleTags || !Array.isArray(exampleTags)) <span class="cstat-no" title="statement not covered" >return [];</span>
