...
<head>
    <title>Code coverage report for transforms/paths/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">transforms/paths</a> index.js</h1>
        <div class='clearfix'>
...
<a name='L64'></a><a href='#L64'>64</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const debug = require('debug')('express-jsdoc-swagger:transforms:paths');
...
&nbsp;
const formatTags = (tags = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> =&gt; tags.map(({ description: name }) =&gt; name);
&nbsp;
...
const parsePath = (path, state) =&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!method) <span class="cstat-no" title="statement not covered" >return {};</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Jun 03 2020 00:58:28 GMT+0200 (Central European Summer Time)
            </div>
        </div>
